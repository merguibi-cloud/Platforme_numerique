...
import FormateurCourseManager from '../components/FormateurCourseManager';
...
export default function GestionCours() {
  ...
  const [schoolsData, setSchoolsData] = useState(() => 
    schools.map(school => ({
      ...school,
      isSelected: school.id === 'leader-society',
            ...
            <div className="flex items-center justify-between">
              ...
              <div className="flex items-center gap-4">
                ...
                <div className="flex items-center gap-3 border border-[#032622] bg-[#F8F5E4] px-4 py-2">
                  ...
                  <div>
                    <p className="text-xs uppercase font-semibold tracking-[0.2em]">Jean Dupont</p>
                    <p className="text-[11px] text-[#032622]/70">Formateur</p>
                  </div>
                </div>
              </div>
            </div>
