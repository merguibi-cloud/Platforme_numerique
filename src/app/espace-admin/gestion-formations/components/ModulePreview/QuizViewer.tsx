...
export const QuizViewer = ({ quiz, questions, isPreview = true }: QuizViewerProps) => {
    ...
    return (
      <div className="space-y-6">
        ...
        <div className="text-center">
          <div className="inline-block bg-[#032622] rounded-lg p-8 mb-4">
            ...
            return (
              <div key={question.id} className="bg-[#F8F5E4] border-2 border-[#032622] rounded-lg p-6">
                ...
                <div className="space-y-2 mb-4">
                  {question.reponses_possibles?.map((reponse) => {
                    ...
                    return (
                      <div
                        key={reponse.id}
                        className={`${bgColor} ${borderColor} border-2 rounded-lg p-4 flex items-center gap-3`}
                      >
                        {isSelected && isCorrectAnswer && <Check className="w-5 h-5 text-green-600" />}
                        {isSelected && !isCorrectAnswer && <X className="w-5 h-5 text-red-600" />}
                        {!isSelected && isCorrectAnswer && <Check className="w-5 h-5 text-green-400" />}
                ...
                {question.justification && (
                  <div className="bg-[#032622] text-[#F8F5E4] p-4 rounded-lg">
  ...
  return (
    <div className="space-y-6">
      ...
      {/* Question actuelle */}
      <div className="bg-[#F8F5E4] border-2 border-[#032622] rounded-lg p-8">
        <div className="mb-6">
      ...
      <div className="flex items-center justify-between">
        <button
          ...
          className={`flex items-center gap-2 px-6 py-3 rounded-lg font-bold uppercase transition-colors ${
        ...
        <button
          onClick={handleNext}
          className="flex items-center gap-2 px-6 py-3 bg-[#032622] text-[#F8F5E4] rounded-lg font-bold uppercase hover:bg-[#032622]/90 transition-colors"
          style={{ fontFamily: 'var(--font-termina-bold)' }}
        >
