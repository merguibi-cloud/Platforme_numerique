...
export default function GestionInscriptionsPage() {
  ...
  return (
    <div className="flex-1 p-6 md:p-10 bg-[#F8F5E4] min-h-screen">
      ...
      <div className="mb-8">
        <h1
          className="text-3xl md:text-4xl font-bold text-[#032622] mb-4"
      ...
      {isLoading ? (
        ...
        <div className="text-center py-12 border border-[#032622] bg-[#F8F5E4]">
          <p className="text-[#032622] text-lg mb-2">Aucune inscription trouvée</p>
        ...
        <div className="border border-[#032622] bg-[#F8F5E4] overflow-x-auto">
          <table className="w-full">
            <thead className="bg-[#032622] text-[#F8F5E4]">
              <tr>
                <th className="px-4 py-3 text-left text-sm font-semibold uppercase tracking-wide">Type</th>
                ...
                <th className="px-4 py-3 text-left text-sm font-semibold uppercase tracking-wide">Date</th>
              ...
              {filteredInscriptions.map((inscription) => (
                ...
                >
                  <td className="px-4 py-3">
                    <span className={`px-2 py-1 text-xs font-semibold text-white ${getTypeColor(inscription.type)}`}>
                  ...
                  <td className="px-4 py-3">
                    <span className={`px-2 py-1 text-xs font-semibold text-white ${getStatusColor(inscription.status)}`}>
